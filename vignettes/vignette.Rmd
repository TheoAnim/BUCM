---
title: "Bayesian Underreported Count Modeling"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Bayesian Underreported Count Modeling}
...
yobs <- rpois(nobs, lambda = lambda * p)
```
...
yobs2 <- rpois(nobs, lambda = lambda2 * p2)
```
